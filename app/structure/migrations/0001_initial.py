    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sent_char_W', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=120), default=structure.models.default_1d_array, null=True, size=None)),
                ('sent_pinyin_W', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=120), default=structure.models.default_1d_array, null=True, size=None)),
                ('sent_lang_W', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=120), default=structure.models.default_1d_array, null=True, size=None)),
